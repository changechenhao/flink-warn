...
import static com.flink.warn.config.Parameters.LATENCY_SINK;
import static com.flink.warn.config.Parameters.LATENCY_TOPIC;
  ...
  public static SinkFunction<String> createLatencySink(Config config) throws IOException {
    ...
    switch (latencySinkType) {
      case KAFKA:
        ...
        return new FlinkKafkaProducer010<>(latencyTopic, new SimpleStringSchema(), kafkaProps);
      case PUBSUB:
